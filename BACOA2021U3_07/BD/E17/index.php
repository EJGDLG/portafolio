...
<body>
	<center>
		...
		<form method="POST" name="frmdepartamento" action="actualizardepto.php">
			<table>
				<tr>
					...
					<tr>
					<td>Nombre <br> Departamento:</td>
					<td>
						<input type="text" name="txtnombredepto">
					</td>
				</tr>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<input type="submit" class="btn btn-primary" name="btningrear" value="Actualizar">
