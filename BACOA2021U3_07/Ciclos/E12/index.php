...
<body>
	<center>
		...
		<h2>Ejercicio 12</h2>
		<h3>Ciclos</h3>
		<h4>Elabora unn formulario que permita ingresar dos numeros</h4>
		<br>
		<br>
		<form method="POST" name="FrmE012" action="Res012.php">
			<table>
				<tr>
					<td width="75">Primer valor</td>
					<td><input type="text" name="TxtPrimero"></td>
				</tr>
				<tr>
