...
<html>
<head>
	<title>Formulario Multiplicacion</title>
	<meta charset="utf-8">
</head>
<body>
	<center>
		<h1>Elabora un formulario que permita infresar tres numeros y muestre la multiplicacion de cada uno de los números.</h1>
		...
		<table border="1">
				<tr>
					<td>
						<form method="POST" action="Resmulti.php" name="frmSuma">
							<table>
								<tr>
									<td>Numero 1</td>
